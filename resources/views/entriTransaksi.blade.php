...
@section('title-halaman')
    Dashboard Entri Transaksi
@endsection

@section('title')
    <h1 class="text-xl font-semibold" style="font-family: 'Helvetica', 'Arial', sans-serif;">Entri Transaksi</h1>
@endsection

@section('description')
    <p class="text-gray-600" style="font-family: 'Helvetica', 'Arial', sans-serif;">Semua jumlah Entri Transaksi muncul di bidang
        ini</p>
@endsection
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <form action="" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-gray-300 text-sm font-semibold mb-2" for="id_transaksi">
                            ID Transaksi
                        </label>
                        <input
                            ...
                            id="id_transaksi" name="id_transaksi" type="number" placeholder="" required readonly>
                    </div>
                    <div>
                        ...
                        <input
                            class="w-full bg-gray-700 text-gray-100 border border-gray-600 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-teal-500 transition duration-200"
                            id="id_pesanan" name="id_pesanan" type="text" placeholder="1234567890" required>
                    </div>
                    <div>
                        ...
                        <input
                            class="w-full bg-gray-700 text-gray-100 border border-gray-600 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-teal-500 transition duration-200"
                            id="bayar" name="bayar" type="number" placeholder="1" required>
                    </div>
                    <div>
                        <label class="block text-gray-300 text-sm font-semibold mb-2" for="total">
                            Total
                        </label>
                        <input
                            class="w-full bg-gray-700 text-gray-100 border border-gray-600 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-teal-500 transition duration-200"
                            id="total" name="total" type="text" placeholder="Rp 30.000" required readonly>
                    </div>
                </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-400">
                                        Apakah Anda yakin ingin menghapus data transaksi <span id="transactionName" class="font-bold text-teal-400"></span>?
                                    </p>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
<script>
    function openDeleteModal(id_transaksi, nama) {
        document.getElementById('deleteModal').classList.remove('hidden');
        document.getElementById('transactionName').textContent = nama;
        document.getElementById('deleteForm').action = "/" + id_transaksi;
    }
